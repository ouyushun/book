function Swipe(e,t){
    ...
    function c(){
        ...
        var t=o.length;
        while(t--){
            var n=o[t];n.style.width=a+"px",
                n.setAttribute("data-index",t),
            i.transitions&&(n.style.left=t*-a+"px",
                v(t,f>t?-a:f<t?a:0,0))}i.transitions||(s.style.left=f*-a+"px"),
