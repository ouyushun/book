    ...
    <form action="" method="post" class="form form-horizontal" id="form-product-edit">
      ...
      <select class="select" name="category_id" size="1">
        @foreach($categories as $category)
              ...
              @if($product->category_id == $category->cate_id)
                  selected
        ...
        <div class="row cl">
            ...
            <div class="formControls col-8">
                <script id="editor" type="text/plain" style="width:100%; height:400px;">{!! $pdt_content->pdt_content !!}</script>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-8">
                    @if(isset($pdt_images[0]) && $pdt_images[0] != null)
                        <img id="preview_id1" src="{{$pdt_images[0]->image_path}}" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id1').click()" />
                    ...
                    @if(isset($pdt_images[1]) && $pdt_images[1] != null)
                        <img id="preview_id2" src="{{$pdt_images[1]->image_path}}" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id2').click()" />
                    ...
                    @if(isset($pdt_images[2]) && $pdt_images[2] != null)
                        <img id="preview_id3" src="{{$pdt_images[2]->image_path}}" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id3').click()" />
                    ...
                    @if(isset($pdt_images[3]) && $pdt_images[3] != null)
                        <img id="preview_id4" src="{{$pdt_images[3]->image_path}}" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id4').click()" />
                    ...
                    @if(isset($pdt_images[4]) && $pdt_images[4] != null)
                        <img id="preview_id5" src="{{$pdt_images[4]->image_path}}" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id5').click()" />
