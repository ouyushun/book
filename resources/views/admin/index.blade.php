...
@section('content')
<header class="Hui-header cl"><a class="Hui-logo l" title="书店" href="/admin/index">My书店</a><span class="Hui-subtitle l">后台</span>
	<ul class="Hui-userbar">
		<li></li>
		<li><a href="/admin/service/exit">退出</a></li>
	...
	<div id="Hui-tabNav" class="Hui-tabNav">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="系统配置" data-href="/">系统配置</span><em></em></li>
			</ul>
		</div>
