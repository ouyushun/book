...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta name="Generator" content="master.blade" />
    ...
    <div id="actionSheet_wrap">
        ...
        <div class="weui_actionsheet" id="weui_actionsheet">
            <div class="weui_actionsheet_menu">
                ...
                <div class="weui_actionsheet_cell" onclick="onMenuItemClick(2)">选择书籍</div>
                <div class="weui_actionsheet_cell" onclick="onMenuItemClick(3)">我的购物车</div>
