...
@section('title','注册')  <!--两个参数，已经闭合，无需关闭-->
...
@section('content')
    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input class="weui_input" type="password" placeholder="不少于6位" name='passwd_phone_confirmation'/>
            </div>
        </div>
        <div class="weui_cell">
    ...
    <div class="weui_cells weui_cells_form" style="display: none;">
        ...
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">确认密码</label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <input class="weui_input" type="password" placeholder="不少于6位" name='passwd_email_confirmation'/>
            </div>
        </div>
...
@section('my_js')
 ...
 <script>
    ...
    $('.bk_phone_code_send').click(function () {
        ...
        $.ajax({
            url : '{{url('service/validatephone/send')}}',
            dataType : 'json',
            type : "POST",
            ...
            success : function (data) {
                if(data==null){
                    $('.bk_toptips').show();
                    $('.bk_toptips').html("服务端发生错误");
                    window.setTimeout(function(){$('.bk_toptips').hide();},5000);
                    return;
                }
                if(data.status != 0){
                    $('.bk_toptips').show();
        ...
        $('input:radio[name=register_type]').each(function(index, el) {
            if($(this).attr('checked') == 'checked') {
                ...
                if(id == 'x11') {
                    ...
                    confirm = $('input[name=passwd_phone_confirmation]').val();
                    ...
                    confirm = $('input[name=passwd_email_confirmation]').val();
